...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "MAX_FIFO" -parent ${Page_0}
...
proc update_PARAM_VALUE.MAX_FIFO { PARAM_VALUE.MAX_FIFO } {
	# Procedure called to update MAX_FIFO when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.MAX_FIFO { PARAM_VALUE.MAX_FIFO } {
	# Procedure called to validate MAX_FIFO
	return true
}
...
proc update_MODELPARAM_VALUE.MAX_FIFO { MODELPARAM_VALUE.MAX_FIFO PARAM_VALUE.MAX_FIFO } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.MAX_FIFO}] ${MODELPARAM_VALUE.MAX_FIFO}
}
