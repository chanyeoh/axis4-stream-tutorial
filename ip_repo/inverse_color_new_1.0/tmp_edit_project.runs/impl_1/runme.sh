...
HD_PWD='C:/axis_tut/ip_repo/inverse_color_new_1.0/tmp_edit_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log inverse_color_v1_0.vdi -applog -m64 -messageDb vivado.pb -mode batch -source inverse_color_v1_0.tcl -notrace
