...
HD_PWD='C:/axis_tut/ip_repo/inverse_color_new_1.0/tmp_edit_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log inverse_color_v1_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source inverse_color_v1_0.tcl
