...
HD_PWD='C:/axis_tut/tpg/proj/hdmi_out.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_out_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source hdmi_out_wrapper.tcl
