...
HD_PWD='C:/axis_tut/tpg/proj/hdmi_out.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_out_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source hdmi_out_wrapper.tcl -notrace
