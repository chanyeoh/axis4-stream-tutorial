...
HD_PWD='C:/axis_tut/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log inverse_color.vds -m64 -mode batch -messageDb vivado.pb -notrace -source inverse_color.tcl
